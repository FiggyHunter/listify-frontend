...
const Navigation = () => {
  ...
  return (
    <header className="pt-4 z-30 mx-auto relative w-4/5  ">
      <nav
        className={`sm:gap-2 md:gap-0 w-4/5 rounded-br-none ${
          !show ? "-top-16" : "top-3"
      ...
      >
        ...
        <div
          ...
          className={`absolute h-min cursor-pointer self-center bg-red-600 lg:pb-1 px-6  rounded-bl-xl mt-8 top-0 -mb-12  rounded-br-xl -z-10 w-full grid place-content-center pt-1 sm:-bottom-20 sm:pb-1 custom-animation ${
            !show ? "-top-60" : "top-6"
          }`}
        >
          ADMIN
