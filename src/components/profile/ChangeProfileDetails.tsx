  ...
  return (
    ...
    >
      <section
        ...
        className="bg-bkg sm:w-5/6  lg:w-1/2 mx-auto rounded-2xl overflow-hidden "
      >
        <div className="flex flex-row">
          <button
            onClick={() => setCurrentTab("profile")}
            className={`${
              currentTab === "profile" ? "bg-bkgContrast" : "bg-transparent"
          ...
          <button
            ...
            className={`${
              currentTab === "password"
                ? "bg-bkgContrast rounded-bl-3xl"
                : "bg-transparent"
            } w-1/2  rounded-none pl-4 py-3 rounded-bl-2xl  flex items-center gap-3"
            `}
          >
            <div className="">
              <svg
